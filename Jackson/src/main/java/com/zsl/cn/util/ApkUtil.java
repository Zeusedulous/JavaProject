...
public class ApkUtil {
        ...
        //  apk的绝对地址
        private static String apk = "C:\\Users\\zsl\\Documents\\apk\\5.apk";
        //  拷贝图标的存放位置
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                if (file.exists() && file.isFile()) {
                    ...
                    System.out.println(apkMeta.getCompileSdkVersion());
                    System.out.println(apkMeta.getCompileSdkVersionCodename());
                    System.out.println(apkMeta.getConfigForSplit());
                    ...
                    System.out.println(apkMeta.getPlatformBuildVersionCode());
                    System.out.println(apkMeta.getPlatformBuildVersionName());
                    System.out.println(apkMeta.getRevisionCode());
                    System.out.println(apkMeta.getSharedUserId());
                    System.out.println(apkMeta.getSharedUserLabel());
                    System.out.println(apkMeta.getSplit());
